'use strict'; /*jslint -W100, browser:true*/
    ...
    "Add the free media player": {
        "message": "Додайте безкоштовний медіаплеєр"
    },
    "All ($1)": {
        "message": "Всі ($1)"
    },
    ...
    "Enjoying Hola for your browser?": {
        "message": "Дивимося Hola для вашого браузера?"
    },
    ...
    "Get free Hola client for better performance!": {
        "message": "Отримати безкоштовний клієнт Hola для кращої продуктивності!"
    },
    ...
    "Let's try other VPNs!": {
        "message": "Давайте спробуємо інші віртуальні приватні мережі"
    },
    "Library": {
        "message": "Бібліотека"
    },
    ...
    "No, I need help": {
        "message": "Ні, мені потрібна допомога"
    },
    "No, Thanks": {
        "message": "Ні, дякую"
    },
    ...
    "appDesc": {
        "message": "Сайти заблоковані доступу у вашій країні, компанії або школі з Hola! Hola є безкоштовним і простим у використанні!"
    },
    "appDesc_nohola": {
        "message": "Сайти заблоковані доступу у вашій країні, компанії або школі! це розширення вільної і простий у використанні!"
    },
    "appName": {
        "message": "Необмежена Безкоштовний VPN - Hola"
    },
    "appName_nohola": {
        "message": "Необмежена кількість безкоштовних проксі VPN"
    },
    "back to": {
