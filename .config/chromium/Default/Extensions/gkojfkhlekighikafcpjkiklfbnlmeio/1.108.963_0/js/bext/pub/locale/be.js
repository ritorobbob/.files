'use strict'; /*jslint -W100, browser:true*/
    ...
    "Add the free media player": {
        "message": "Дадайце бясплатны медыяплэер"
    },
    "All ($1)": {
        "message": "Усе ($1)"
    },
    ...
    "Enjoying Hola for your browser?": {
        "message": "Глядзім Hola для вашага браўзэра?"
    },
    ...
    "Get free Hola client for better performance!": {
        "message": "Атрымаць бясплатны кліент Hola для лепшай прадукцыйнасці!"
    },
    ...
    "Let's try other VPNs!": {
        "message": "Давайце паспрабуем іншыя віртуальныя прыватныя сеткі"
    },
    "Library": {
        "message": "Бібліятэка"
    },
    ...
    "No, I need help": {
        "message": "Не, мне патрэбна дапамога"
    },
    "No, Thanks": {
        "message": "Не, дзякуй"
    },
    ...
    "appDesc": {
        "message": "Сайты заблакаваныя доступу ў вашай краіне, кампаніі або школе з Hola! Hola з&#39;яўляецца бясплатным і простым ў выкарыстанні!"
    },
    "appDesc_nohola": {
        "message": "Сайты заблакаваныя доступу ў вашай краіне, кампаніі ці школе! гэта пашырэнне свабоднай і просты ў выкарыстанні!"
    },
    "appName": {
        "message": "Неабмежаваную Бясплатны VPN - Hola"
    },
    "appName_nohola": {
        "message": "Неабмежаваная колькасць бясплатных проксі VPN"
    },
    "back to": {
        "message": "вярнуўся да"
    },
