'use strict'; /*jslint -W100, browser:true*/
    ...
    "Add the free media player": {
        "message": "Thêm cầu thủ phương tiện truyền thông miễn phí"
    },
    "All ($1)": {
        "message": "Tất cả ($1)"
    },
    ...
    "Enjoying Hola for your browser?": {
        "message": "Thưởng thức Hola cho trình duyệt của bạn?"
    },
    ...
    "Get free Hola client for better performance!": {
        "message": "Nhận khách hàng Hola miễn phí cho hiệu suất tốt hơn!"
    },
    ...
    "No, I need help": {
        "message": "Không, tôi cần sự giúp đỡ"
    },
    "No, Thanks": {
    ...
    "appDesc": {
        "message": "Truy cập trang web bị chặn trong nước, công ty hay trường học của bạn với Hola! Hola là miễn phí và dễ sử dụng!"
    },
    "appDesc_nohola": {
        "message": "Truy cập trang web bị chặn trong nước, công ty hay trường học của bạn! mở rộng này là miễn phí và dễ sử dụng!"
    },
    "back to": {
        "message": "sao đến"
    },
