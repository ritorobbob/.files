...
define(['jquery', 'underscore', 'backbone', '/util/escape.js',
    '/util/user_agent.js', '/bext/pub/locale.js'],
    function($, _, Backbone, zescape, user_agent, T){
var E = {};
...
E.init_globals = function(root, country_code, link, text){
    ...
    var t = text!==undefined ? function(){ return text; } :
...
E.SocialSharing = Backbone.View.extend({
	...
	assign(params, {'data-toggle': 'tooltip', 'data-placement': 'top'});
	return $(user_agent.guess_browser().android ? '<span>' : '<a>',
            params);
    },
