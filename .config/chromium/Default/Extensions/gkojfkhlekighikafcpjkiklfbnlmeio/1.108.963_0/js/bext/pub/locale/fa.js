'use strict'; /*jslint -W100, browser:true*/
    ...
    "Add the free media player": {
        "message": "اضافه کردن دستگاه پخش رسانه ای رایگان"
    },
    "All ($1)": {
        "message": "همه ($1)"
    },
    ...
    "Enjoying Hola for your browser?": {
        "message": "سلام برای لذت بردن از مرورگر خود را؟"
    },
    ...
    "Get free Hola client for better performance!": {
        "message": "مطلع مشتری سلام رایگان برای عملکرد بهتر!"
    },
    ...
    "Let's try other VPNs!": {
        "message": "بیایید سعی کنید VPN ها دیگر"
    },
    "Library": {
        "message": "کتابخانه"
    },
    ...
    "appDesc": {
        "message": "دسترسی به وب سایت های مسدود شده در کشور، شرکت و یا مدرسه خود را با سلام! سلام رایگان و آسان برای استفاده است."
    },
    "appDesc_nohola": {
        "message": "دسترسی به وب سایت های مسدود شده در کشور، شرکت و یا مدرسه خود را! این افزونه رایگان و آسان برای استفاده است."
    },
    "appName": {
        "message": "فضای مجاز: نامحدود VPN رایگان - سلام"
    },
    "appName_nohola": {
        "message": "فضای مجاز: نامحدود رایگان پروکسی VPN"
    },
    "back to": {
        "message": "برگرد به"
    },
