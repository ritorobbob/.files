'use strict'; /*jslint -W100, browser:true*/
    ...
    "Add the free media player": {
        "message": "مفت میڈیا پلیئر میں شامل کریں"
    },
    "All ($1)": {
        "message": "تمام ($1)"
    },
    ...
    "Enjoying Hola for your browser?": {
        "message": "اپنے براؤزر کے لئے ہیلو سے لطف اندوز؟"
    },
    ...
    "Get free Hola client for better performance!": {
        "message": "بہتر کارکردگی کے لئے مفت ہیلو کلائنٹ ہو جاؤ!"
    },
    ...
    "Let's try other VPNs!": {
        "message": "دوسرے وپ کی کوشش کرتے ہیں"
    },
    "Library": {
        "message": "لائبریری"
    },
    ...
    "No, I need help": {
        "message": "کوئی، مجھے مدد کی ضرورت"
    },
    "No, Thanks": {
        "message": "نہیں، شکریہ"
    },
    ...
    "appDesc": {
        "message": "رسائی ویب سائٹ ہیلو کے ساتھ اپنے ملک، کمپنی یا اسکول میں بلاک! ہیلو مفت اور استعمال میں آسان ہے!"
    },
    "appDesc_nohola": {
        "message": "رسائی کی ویب سائٹ آپ کے ملک، کمپنی یا اسکول میں بلاک! اس توسیع مفت اور استعمال میں آسان ہے!"
    },
    "appName": {
        "message": "لا محدود مفت ویپیین - ہیلو"
    },
    "appName_nohola": {
        "message": "لا محدود مفت پراکسی ویپیین"
    },
    "back to": {
        "message": "پر واپس"
    },
