'use strict'; /*jslint -W100, browser:true*/
    ...
    "Add the free media player": {
        "message": "Přidejte si bezplatný multimediální přehrávač"
    },
    "All ($1)": {
        "message": "Vše ($1)"
    },
    ...
    "Enjoying Hola for your browser?": {
        "message": "Radost Hola pro váš prohlížeč?"
    },
    ...
    "Get free Hola client for better performance!": {
        "message": "Získejte zdarma Hola klienta pro lepší výkon!"
    },
    ...
    "appDesc": {
        "message": "Webové stránky přístup k blokovaným ve vaší zemi, firmy nebo školy s Hola! Hola je zdarma a snadno použitelný!"
    },
    "appDesc_nohola": {
        "message": "Webové stránky přístup k blokovaným ve vaší zemi, firmy nebo školy! Toto rozšíření je zdarma a snadno použitelný!"
    },
    "appName": {
        "message": "Neomezené VPN - Hola"
    },
    "appName_nohola": {
        "message": "Neomezené Proxy VPN"
    },
    "back to": {
        "message": "zpátky na"
    },
