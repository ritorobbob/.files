'use strict'; /*jslint -W100, browser:true*/
    ...
    "Add the free media player": {
        "message": "Menambah pemain media percuma"
    },
    "All ($1)": {
        "message": "Semua ($1)"
    },
    ...
    "Enjoying Hola for your browser?": {
        "message": "Menikmati Hola untuk penyemak imbas anda?"
    },
    ...
    "Get free Hola client for better performance!": {
        "message": "Dapatkan Hola pelanggan percuma untuk prestasi yang lebih baik!"
    },
    ...
    "Let's try other VPNs!": {
        "message": "Mari kita cuba VPN lain"
    },
    "Library": {
    ...
    "No, I need help": {
        "message": "Tidak, saya memerlukan bantuan"
    },
    "No, Thanks": {
    ...
    "appDesc": {
        "message": "Mengakses laman web disekat di negara anda, syarikat atau sekolah dengan Hola! Hola adalah percuma dan mudah untuk digunakan!"
    },
    "appDesc_nohola": {
        "message": "Mengakses laman web disekat di negara anda, syarikat atau sekolah! perluasan ini adalah percuma dan mudah untuk digunakan!"
    },
    "appName": {
        "message": "Unlimited Percuma VPN - Hola"
    },
    "appName_nohola": {
        "message": "Unlimited Proxy VPN Percuma"
    },
    "back to": {
