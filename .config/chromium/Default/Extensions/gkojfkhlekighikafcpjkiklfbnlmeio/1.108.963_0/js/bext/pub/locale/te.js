'use strict'; /*jslint -W100, browser:true*/
    ...
    "Add the free media player": {
        "message": "ఉచిత మీడియా ప్లేయర్ జోడించండి"
    },
    "All ($1)": {
        "message": "అన్ని ($1)"
    },
    ...
    "Enjoying Hola for your browser?": {
        "message": "మీ బ్రౌజర్ కోసం Hola ఆనందించే?"
    },
    ...
    "Get free Hola client for better performance!": {
        "message": "మెరుగైన పనితీరు కోసం ఉచిత హోలా క్లయింట్ పొందండి!"
    },
    ...
    "Let's try other VPNs!": {
        "message": "యొక్క ఇతర VPN లు ప్రయత్నించండి లెట్"
    },
    "Library": {
        "message": "లైబ్రరీ"
    },
    ...
    "appDesc": {
        "message": "యాక్సెస్ వెబ్సైట్లు Hola తో మీ దేశం, కంపెనీ లేదా పాఠశాలలో బ్లాక్! హోలా ఉచితం మరియు ఉపయోగించడానికి సులభం!"
    },
    "appDesc_nohola": {
        "message": "యాక్సెస్ వెబ్సైట్లు మీ దేశం, కంపెనీ లేదా పాఠశాలలో బ్లాక్! ఈ పొడిగింపు ఉచితం మరియు ఉపయోగించడానికి సులభం!"
    },
    "appName": {
        "message": "అపరిమిత ఉచిత VPN - Hola"
    },
    "appName_nohola": {
        "message": "అపరిమిత ఉచిత ప్రాక్సీ VPN"
    },
    "back to": {
        "message": "కు వెనుకకు"
    },
