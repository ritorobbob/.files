'use strict'; /*jslint -W100, browser:true*/
    ...
    "Add the free media player": {
        "message": "ücretsiz medya oynatıcı ekle"
    },
    "All ($1)": {
        "message": "Hepsi ($1)"
    },
    ...
    "Enjoying Hola for your browser?": {
        "message": "Tarayıcınız için Hola Enjoying?"
    },
    ...
    "Get free Hola client for better performance!": {
        "message": "Daha iyi performans için ücretsiz Hola istemcisi alın!"
    },
    ...
    "No, I need help": {
        "message": "Hayır, yardıma ihtiyacım var"
    },
    "No, Thanks": {
    ...
    "appDesc": {
        "message": "Erişim siteleri Hola Ülkenizi, şirket ya da okulda engellendi! Hola ücretsiz ve kullanımı kolay!"
    },
    "appDesc_nohola": {
        "message": "Erişim web sitelerinin ülke, şirket ya da okulda engellendi! Bu uzantı ücretsiz ve kullanımı kolay!"
    },
    "appName": {
        "message": "Sınırsız Ücretsiz VPN - Hola"
    },
    "appName_nohola": {
        "message": "Sınırsız Ücretsiz Vekil VPN"
    },
    "back to": {
        "message": "geri"
    },
