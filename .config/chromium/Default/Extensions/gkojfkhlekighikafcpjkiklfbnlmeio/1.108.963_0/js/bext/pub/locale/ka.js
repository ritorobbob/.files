'use strict'; /*jslint -W100, browser:true*/
    ...
    "Add the free media player": {
        "message": "სანიშნეს თავისუფალი მედია მოთამაშე"
    },
    "All ($1)": {
        "message": "ყველა ($1)"
    },
    ...
    "Enjoying Hola for your browser?": {
        "message": "მოსარგებლე Hola თქვენი ბრაუზერის?"
    },
    ...
    "Get free Hola client for better performance!": {
        "message": "მიიღეთ უფასო Hola კლიენტს უკეთესი შესრულება!"
    },
    ...
    "appDesc": {
        "message": "წვდომა ვებ ბლოკირებული თქვენს ქვეყანაში, კომპანია ან სკოლაში Hola! Hola არის უფასო და მარტივი!"
    },
    "appDesc_nohola": {
        "message": "წვდომა ვებ ბლოკირებული თქვენს ქვეყანაში, კომპანია ან სკოლაში? ეს გაფართოება არის უფასო და მარტივი!"
    },
    "appName": {
        "message": "შეუზღუდავი უფასო VPN - Hola"
    },
    "appName_nohola": {
        "message": "შეუზღუდავი უფასო Proxy VPN"
    },
    "back to": {
        "message": "თავში"
    },
