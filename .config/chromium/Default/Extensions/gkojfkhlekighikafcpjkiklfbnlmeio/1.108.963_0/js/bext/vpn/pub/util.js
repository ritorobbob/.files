...
define(['underscore', '/util/etask.js', '/util/url.js', '/util/util.js',
    '/protocol/pub/countries.js', '/svc/pub/util.js', '/util/version_util.js'],
    function(_, etask, zurl, zutil, pcountries, svc_util, version_util){
var E = {};
...
// XXX arik: rm proxy_countries, just use protocol/pub/countries.js
