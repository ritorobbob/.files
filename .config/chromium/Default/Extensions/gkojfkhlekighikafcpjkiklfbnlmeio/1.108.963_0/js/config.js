...
function get_paths(base_url, ver){
    ...
    var f = {
        local: {
            ...
            'views/country_premium':
                'BASE/bext/vpn/pub/country_premium.html?noext',
            ...
            'views/site_trial_try':
                'BASE/bext/vpn/pub/site_trial_try.html?noext',
            'views/site_trial_timer':
                'BASE/bext/vpn/pub/site_trial_timer.html?noext',
            'views/site_trial_ended':
                'BASE/bext/vpn/pub/site_trial_ended.html?noext',
        },
        local_ccgi: {
        ...
        remote: {
            ...
            'views/country_premium':
                'BASE/bext/vpn/pub/country_premium.html',
            ...
            'views/site_trial_try':
                'BASE/bext/vpn/pub/site_trial_try.html',
            'views/site_trial_timer':
                'BASE/bext/vpn/pub/site_trial_timer.html',
            'views/site_trial_ended':
                'BASE/bext/vpn/pub/site_trial_ended.html',
        },
        remote_common: {
...
'/bext/vpn/pub/site_trial_ui.js': 'BASE/bext/vpn/pub/site_trial_ui.js',
