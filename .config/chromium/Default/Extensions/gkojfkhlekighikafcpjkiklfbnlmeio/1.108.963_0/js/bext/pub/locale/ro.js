'use strict'; /*jslint -W100, browser:true*/
    ...
    "Add the free media player": {
        "message": "Adăugați gratuit media player"
    },
    "All ($1)": {
        "message": "Toate ($1)"
    },
    ...
    "Enjoying Hola for your browser?": {
        "message": "Bucurându-se de Hola pentru browser-ul dvs.?"
    },
    ...
    "Get free Hola client for better performance!": {
        "message": "Ia-client gratuit Hola pentru o performanță mai bună!"
    },
    ...
    "No, I need help": {
        "message": "Nu, am nevoie de ajutor"
    },
    "No, Thanks": {
    ...
    "appDesc": {
        "message": "Site-uri de acces blocate in tara, compania dumneavoastră sau de la școală cu Hola! Hola este gratuit și ușor de utilizat!"
    },
    "appDesc_nohola": {
        "message": "Site-uri de acces blocate în țară, compania sau școala dumneavoastră! această extindere este gratuit și ușor de folosit!"
    },
    "appName": {
        "message": "Nelimitat VPN gratuit - Hola"
    },
    "appName_nohola": {
        "message": "Nelimitat Proxy gratuit VPN"
    },
    "back to": {
        "message": "înapoi la"
    },
