'use strict'; /*jslint -W100, browser:true*/
    ...
    "Add the free media player": {
        "message": "Bæta frjálsa miðöldum leikmaður"
    },
    "All ($1)": {
        "message": "Allt ($1)"
    },
    ...
    "Enjoying Hola for your browser?": {
        "message": "Njóta Hola fyrir vafrann þinn?"
    },
    ...
    "Get free Hola client for better performance!": {
        "message": "Fá ókeypis Hola viðskiptavinur fyrir betri árangur!"
    },
    ...
    "Let's try other VPNs!": {
        "message": "Við skulum reyna aðrar VPNs"
    },
    "Library": {
        "message": "Bókasafn"
    },
    ...
    "appDesc_nohola": {
        "message": "Aðgangur vefsíður lokað í þínu landi, fyrirtæki eða skóla! þetta eftirnafn er ókeypis og auðvelt að nota!"
    },
    "appName": {
        "message": "Ótakmarkaður Frjáls VPN - Hola"
    },
    "appName_nohola": {
        "message": "Ótakmarkaður Frjáls Proxy VPN"
    },
    "back to": {
